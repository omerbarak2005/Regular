...
PIPELINE_ROWS = [
    ...
    # ── SILVER TSUNAMI ADDS — Elevator | Funeral | Calibration | Shredding ──
    {
        ...
        "Est. Employees":     "50–75",
        "Ownership Type":     "Family (Rob Bailey, ~74 yrs)",
        "Year Founded":       "~1972",
        ...
        "Last Outreach Date": "",
        "Next Step":          "Call (773) 486-6900 — ask for Rob. Son Cullen now handles day-to-day; the succession is live. ZoomInfo shows r***@mid-americanelevator.com = rbailey.",
        "Notes / Why Attractive": "Rob Bailey is ~74 years old (Northwestern class of 1974). 50+ year Chicago elevator company. Son Cullen has stepped into operations — textbook succession signal already in motion. APi Group (post-Elevated Facility Services deal) and 3Phase Elevator both actively buying Chicago metro add-ons. ZoomInfo confirms r***@mid-americanelevator.com.",
    ...
    },
    {
        ...
        "Ownership Type":     "Family (3rd gen)",
        "Year Founded":       "~1948",
        "Multi-Location?":    "Yes (Kettering + Miamisburg OH)",
        "Priority Score":     "1",
        "Status":             "Researching",
    ...
    },
    {
        ...
        "State":              "OH",
        "City/HQ":            "Willoughby",
        "Industry":           "Calibration & Metrology Labs",
        "Est. Revenue":       "$3M–$7M",
        "Est. EBITDA":        "$600K–$1.4M",
        "Est. Employees":     "15–35",
        "Ownership Type":     "Founder-owned",
        "Year Founded":       "~1992",
        "Multi-Location?":    "No",
        "Priority Score":     "1",
        "Status":             "Researching",
        "Contact Name":       "Gary Cremeens",
        "Title":              "Founder & President",
        "Email":              "gcremeens@e2bcal.com",
        "Phone":              "(440) 942-1500",
        "LinkedIn URL":       "linkedin.com/company/e2b-calibration/",
        "Last Outreach Date": "",
        "Next Step":          "Call (440) 942-1500, ask for Gary. Reference Transcat's 26 acquisitions and what ISO 17025 labs in NE Ohio trade for. He has no banker calling him — that's the edge.",
        "Notes / Why Attractive": "ISO 17025 accredited calibration lab, Willoughby OH. Gary Cremeens is the founder. Serves manufacturing, aerospace, and pharma clients in Cleveland / NE Ohio. Exactly the size and profile Transcat (NASDAQ: TRNS, 26 acquisitions) and Trescal target. 30+ years of recurring relationships = clean book of business. Zero generalist bankers are calling calibration labs this size.",
        "Verification Needed": "Confirm Gary still active owner; verify email (g.cremeens@ also possible); confirm ISO 17025 accreditation still current; check Transcat hasn't already approached",
    },
    {
        "Company Name":       "Geib Funeral Home & Cremation",
        "Website":            "geibcares.com",
        "State":              "OH",
        "City/HQ":            "Dover",
        "Industry":           "Funeral Homes & Death Care",
        "Est. Revenue":       "$4M–$9M",
        ...
        "Est. Employees":     "20–40",
        "Ownership Type":     "Family (4th gen, est. 1933)",
        "Year Founded":       "1933",
        "Multi-Location?":    "Yes (4 Tuscarawas County OH locations)",
        "Priority Score":     "1",
        "Status":             "Researching",
        "Contact Name":       "Gary Geib",
        "Title":              "Owner / Funeral Director",
        "Email":              "ggeib@geibcares.com",
        "Phone":              "(330) 343-8821",
        "LinkedIn URL":       "geibcares.com/about-us/",
        "Last Outreach Date": "",
        "Next Step":          "Call (330) 343-8821; ask for Gary Geib. 4-location operation = platform deal for Park Lawn or NorthStar. Reference Ohio consolidation happening now.",
        "Notes / Why Attractive": "One of Ohio's oldest funeral homes (est. 1933). Gary Geib is 4th generation. 4 locations in Tuscarawas County: Dover, New Philadelphia, Uhrichsville, Newcomerstown. Strong pre-need contracts + real estate likely included = extra value. Park Lawn (TSX: PLC) is the most aggressive buyer in Ohio right now. 4 locations at once = platform-level deal for NorthStar or Foundation Partners.",
        "Verification Needed": "Confirm Gary as primary decision-maker; verify email; confirm ownership split (sole vs. siblings); check if Park Lawn/SCI already approached",
    },
    {
        ...
        "Est. EBITDA":        "$800K–$2M",
        "Est. Employees":     "25–50",
        "Ownership Type":     "Founder-owned (verify)",
        "Year Founded":       "~1997",
        "Multi-Location?":    "Yes (Northern CA routes)",
        "Priority Score":     "2",
        "Status":             "Researching",
        "Contact Name":       "[verify via website / call]",
        "Title":              "Owner / President",
        "Email":              "[call to get — do not guess]",
        "Phone":              "[visit pacificshredding.com/contact for current number]",
        "LinkedIn URL":       "linkedin.com/company/pacific-shredding/",
        "Last Outreach Date": "",
        "Next Step":          "Step 1: pacificshredding.com → Contact page → get owner name + direct number. Step 2: Call, introduce as M&A advisor in document shredding sector. Do not email before you know the name.",
        "Notes / Why Attractive": "Northern California independent shredder — Sacramento metro + surrounding counties. Founder-owned regional operator with hospital, law firm, and government recurring contracts (HIPAA-certified route base). Iron Mountain, ProShred, and Greenway all buying CA operators. Route-density play = PE loves it. Must verify owner name via website or LinkedIn before any outreach.",
        "Verification Needed": "Get owner name from website or LinkedIn before outreach; confirm still independent (not acquired); verify fleet size; confirm HIPAA certification",
    },
]
...
def build_workbook(output_path: str):
    ...
    email_rows = [
        ...
        ("E2B Calibration",         "Gary Cremeens",       "gcremeens@e2bcal.com",               "(440) 942-1500", "Estimated"),
        ("Geib Funeral Home",       "Gary Geib",           "ggeib@geibcares.com",                "(330) 343-8821", "Estimated"),
        ("Pacific Shredding",       "[call to verify]",    "[get from website first]",           "[verify]",       "CALL FIRST"),
    ]
